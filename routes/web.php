...
Route::get('/propos', [DashboardController::class, 'propos'])->name('propos');
Route::get('/work', [DashboardController::class, 'work'])->name('work');
Route::get('/exchange-rate', [ExchangeRateController::class, 'indexU'])->name('exchange_rates');
Route::get('/exchange-rates', [TransactionController::class, 'transaction'])->name('transaction');
