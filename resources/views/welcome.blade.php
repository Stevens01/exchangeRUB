...
<title>Échangez RUB et FCFA en toute simplicité - ExchangeRUB</title>
...
@section('title', 'Échangez RUB et FCFA en toute simplicité')
    
    @section('content')
        <!-- Hero Section -->
        <section class="hero bg-gradient-to-r from-blue-300 to-blue-200 text-white w-full"><br>
            <br>
            <div class="hero-content max-w-4xl text-center">
                ...
                <p class="text-xl mb-8 opacity-90">
                    Des taux compétitifs, des transactions sécurisées et un service rapide pour tous vos échanges entre le Rouble Russe et le Franc CFA.
                </p>

                <a href="{{ route('exchange.create') }}" 
                    class="btn btn-primary text-lg inline-flex items-center gap-2 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl group">
                    Faire un échange maintenant
        ...
        <!-- Converter Section -->
        <section id="converter" class="py-12 bg-white mt-12">
            <div class="container">
...
<!-- Rates Section -->
<section class="rates py-12 bg-white w-screen">
    <div class="w-full px-4 md:px-8 lg:px-16">
      <h2 class="section-title text-center text-3xl font-bold text-gray-800 mb-8">
        Taux de change actuels
      </h2>
      <div class="overflow-x-auto">
        <table class="rates-table w-full bg-white shadow-md">
